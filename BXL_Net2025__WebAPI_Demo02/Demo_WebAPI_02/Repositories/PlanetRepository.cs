...
public class PlanetRepository
{
    ...
    {
        string query = " OUTPUT [inserted].[id], [inserted].[name], [inserted].[desc], [inserted].[nb_moon] as [nbmoon], [inserted].[discovery_date] as [discoverydate], [inserted].[solar_system_id] AS [SolarSystemId]" +
